...
SELECT ce.anyo_inicio, COUNT(DISTINCT ama.id_alumno) as total FROM alumno_se_matricula_asignatura ama JOIN curso_escolar ce ON ama.id_curso_escolar = ce.id GROUP BY ce.anyo_inicio;
