...
SELECT g.nombre AS grau, a.tipo AS tipo, SUM(a.creditos) AS total_creditos FROM grado AS g INNER JOIN asignatura AS a ON a.id_grado = g.id GROUP BY g.nombre, a.tipo ORDER BY g.nombre, a.tipo;
