...
SELECT pe.apellido, pe.apellido2, pe.nombre FROM persona AS pe INNER JOIN profesor AS pr ON pr.id_profesor = pe.id LEFT JOIN asignatura AS a ON a.id_profesor = pr.id_profesor WHERE a.id_profesor IS NULL ORDER BY pe.apellido1, pe.apellido2, pe.nombre;
